...
public enum RailType implements IGui {
    ...
    CREATIVE450 (450, MapColor.getDarkRedMapped(), false, true, true, Rail.Shape.QUADRATIC),
    CREATIVE500(500, MapColor.getPinkMapped(), false, true, true, Rail.Shape.QUADRATIC),
    CREATIVE600(600, MapColor.getWaterBlueMapped(), false, true, true, Rail.Shape.QUADRATIC),
    CREATIVE700(700, MapColor.getBrightRedMapped(), false, true, true, Rail.Shape.QUADRATIC),
    CREATIVE800(800, MapColor.getBlackMapped(), false, true, true, Rail.Shape.QUADRATIC),
    CREATIVE1000(1000, MapColor.getTerracottaBlueMapped(), false, true, true, Rail.Shape.QUADRATIC);
